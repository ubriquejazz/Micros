/*!\name      can_light.c
 *
 * \brief     Simulates a traffic light that can be controlled via can_cop
 ...
 *            - The CANH and CANL transceiver pins should be connected to the same wires 
 *              as the PIC running can_light.c.
...
int LIGHT_Switch (unsigned int c)
{
  switch(c) {
