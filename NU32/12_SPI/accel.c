 ...
 *
 *            the accelerometer and the pic32 are both little endian  
...
int main() 
{
  ...
  while(1) 
  {
    ...
    // 16-bit twos complement numbers, the same as a short
    ...
    // NOTE: the accelerometer is influenced by gravity, meaning that, 
    // on earth, when stationary it measures gravity as a 1g acceleration
