/* Multiple Client Drivers - pag 36 */


DRV_USART_OBJ drvUsart[DRV_USART_INSTANCES_NUMBER]; 
...
// Example: Client API Function Implementation 
	...
	void DRV_USART_BufferAddRead ( const DRV_HANDLE handle, DRV_USART_BUFFER_HANDLE * const bufferHandle, 
