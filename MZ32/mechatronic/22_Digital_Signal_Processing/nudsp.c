/*!\name      nudsp.c
 *
 * \brief     Wraps some dsp library functions making it easier to use them with 
 *            doubles all provided operations assume signal lengths of 1024 elements
 *
 * \author    Juan Gago
 *
 */
...
void nudsp_fir_1024(double *dout,double *din,double *c,int nc,double div_c,double div_sig) 
{
