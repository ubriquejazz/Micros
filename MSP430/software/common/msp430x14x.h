...
#define CSTARTADD_0          (0*0x1000u)    //Conversion start address
#define CSTARTADD_1          (1*0x1000u)    //These bits select which ADC12
#define CSTARTADD_2          (2*0x1000u)    //conversion-memory register is used for a single conversion or for the first
#define CSTARTADD_3          (3*0x1000u)    //conversion in a sequence. The value of CSTARTADDx is 0 to 0Fh,
#define CSTARTADD_4          (4*0x1000u)    //corresponding to ADC12MEM0 to ADC12MEM15.
