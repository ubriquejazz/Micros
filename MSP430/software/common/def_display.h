...
// HD44780 Parameters
// ================
// Los par�metros deben pasarse cada vez que se emplea alguna de las instrucciones
// Set_Entry_Mode
// ==============
...
// Especificaci�n de pines de salida
// =========================================
// Tipo de intrucci�n 7 6 5 4 3 2 1 0
// =============== === === === === === === === ===
...
//Alternativamente pueden especificarse las se�ales de control mediante operaciones al bit.
